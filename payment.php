...
<head>
    ...
    <title>Payment — STES Racing</title>
 ...
 <div>
        <div class="container">
            <div class="row justify-content-center" style="padding-bottom:2vh;">
                <div class="col-6 col-sm-4 col-md-3 col-lg-2 col-xl-2 offset-0 offset-sm-0 offset-md-0 offset-lg-0" style="padding:0px;"><img src="assets/img/Paytm.png" width="100%"></div>
            </div>
        </div>
    </div>
                <div class="container">
	...
	<form method="post" action="pgRedirect">
                                    <tbody>
                                        <tr>
                                            <td style="text-align:center;font-size:calc(1em + 0.2vw);padding-top:25px;">TRANSACTION NUMBER</td>
                                            <td style="text-align:center;padding-top:25px;"><input id="ORDER_ID" readonly tabindex="1" maxlength="12" size="12" name="ORDER_ID" autocomplete="off" value="<?php echo  "SR" . date('ymd') . rand(1,9999) ?>"readonly="" style="text-align:center;font-size:calc(1em + 0.2vw);border-radius:1em;border:none;"></td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:center;font-size:calc(1em + 0.2vw);">CUSTOMER ID</td>
                                            <td style="text-align:center;"><input id="CUST_ID" readonly tabindex="2" maxlength="12" size="12" name="CUST_ID" autocomplete="off" value="<?php echo  "STES" . rand(1,99999999)?>" readonly="" style="text-align:center;font-size:calc(1em + 0.2vw);border-radius:1em;border:none;"></td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:center;font-size:calc(1em + 0.2vw);">PAYMENT TYPE</td>
                                            <td style="text-align:center;"><input id="INDUSTRY_TYPE_ID" readonly tabindex="4" maxlength="12" size="12" name="INDUSTRY_TYPE_ID" autocomplete="off" value="Retail" readonly="" style="text-align:center;font-size:calc(1em + 0.2vw);border-radius:1em;border:none;"></td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:center;font-size:calc(1em + 0.2vw);">CHANNEL</td>
                                            <td style="text-align:center;"><input id="CHANNEL_ID" readonly tabindex="4" maxlength="12"
						size="12" name="CHANNEL_ID" autocomplete="off" value="WEB" style="text-align:center;font-size:calc(1em + 0.2vw);border-radius:1em;border:none;"></td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:center;font-size:calc(1em + 0.2vw);padding-bottom:25px;">DONATION AMOUNT</td>
                                            <td style="text-align:center;padding-bottom:25px;"><input title="TXN_AMOUNT" onkeyup="this.value=this.value.replace(/[^\d]+/,'')" tabindex="10"
						type="tel" minlength="1" maxlength="7" size="12" name="TXN_AMOUNT"
						value="" required placeholder="INR (₹)" style="text-align:center;font-size:calc(1em + 0.2vw);border-radius:1em;border:none;" oninvalid="this.setCustomValidity('Please Enter The Amount you wish to Donate.')" oninput="setCustomValidity('')"></td>
                                        </tr>
                                    </tbody>
                                </table>
                                 <div class="highlight-blue" style="background-color:rgba(0,0,0,0);padding-top:0px;padding-bottom:0px;">
        <div class="container">
            <div class="intro"></div>
            <div class="buttons"><button class="btn btn-primary btn-lg" type="submit" onclick="">CONTRIBUTE</button></div>
        </div>
    </div>
                            </div>
                        </div>
                        ...
                        <div class="footer-dark" style="padding-top:10vh;padding-bottom:0;background-color:rgb(0,0,0);">
        <footer>
